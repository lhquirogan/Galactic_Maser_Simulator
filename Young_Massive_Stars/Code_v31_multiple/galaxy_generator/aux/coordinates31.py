...
from aux.vectorastrometry31 import sphericalToCartesian, cartesianToSpherical, elementaryRotationMatrix, \
    normalTriad
from aux.utils31 import enum, degreesToRadians, radiansToDegrees
