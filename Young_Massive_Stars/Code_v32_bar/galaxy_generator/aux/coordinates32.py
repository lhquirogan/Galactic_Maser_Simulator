...
from aux.vectorastrometry32 import sphericalToCartesian, cartesianToSpherical, elementaryRotationMatrix, \
    normalTriad
from aux.utils32 import enum, degreesToRadians, radiansToDegrees
